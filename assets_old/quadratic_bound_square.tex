...
\begin{tikzpicture}[
	...
	\begin{axis}[
		...
		\node[label={180:$f(x)$}] at (axis cs:1.4,1.4) {};
		...
		\draw [decorate, decoration={brace, amplitude=4pt}, line width=2pt] (axis cs:-2.2,1.675) -- (axis cs:-2.2,3.5) node [midway, anchor=east, xshift=-1mm, outer sep=1pt,font=\tiny, align=left]{\( \Delta \)};
		...
		\draw [decorate, decoration={brace, amplitude=4pt, mirror}, line width=2pt] (axis cs:-0.5, 2.4) -- (axis cs:-0.5,3.5) node [midway, anchor=west, xshift=1mm, outer sep=1pt,font=\tiny]{\( L \)};
		...
		\draw [decorate, decoration={brace, amplitude=4pt, mirror}, line width=2pt] (axis cs:0.5, 1.9) -- (axis cs:0.5, 3.5) node [midway, anchor=west, xshift=1mm, outer sep=1pt,font=\tiny]{\( M_k \)};
	\end{axis}
\end{tikzpicture}
